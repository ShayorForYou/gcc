...
class _CustomStepperState extends State<CustomStepper>
  ...
  bool _isCurrent(int index) {
    return widget.steps[index].state == CustomStepState.complete ||
        widget.steps[index].state == CustomStepState.editing;
  }
  ...
  Widget _buildCircleChild(int index, bool oldState) {
    ...
    return switch (state) {
      ...
      CustomStepState.editing => Icon(null, color: iconColor, size: 18.0),
      CustomStepState.complete =>
        Icon(Icons.check, color: iconColor, size: 18.0),
      CustomStepState.error =>
        const Center(child: Text('!', style: _kStepStyle)),
    };
  }
...
class CustomStepStyle with Diagnosticable {
  ...
  ///
  /// This property only applies when [CustomStepper.type] is [StepperType.horizontal].
